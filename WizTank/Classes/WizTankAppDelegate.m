...
@implementation WizTankAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
	...
	////////////////////////////////////
	if ([[NSUserDefaults standardUserDefaults] objectForKey:UserIDKey] && [[NSUserDefaults standardUserDefaults] objectForKey:authTokenKey]) {
...
- (void)applicationDidBecomeActive:(UIApplication *)application {
     ...
     */
	/*SharedSessions *sharedInstance=[SharedSessions GetInstance];
	if (sharedInstance.categoryList==nil || [sharedInstance.categoryList count]==0) {
		///hit to the server for getting the List///
		[SharedSessions GetCategoriesList];
	}*/
}
